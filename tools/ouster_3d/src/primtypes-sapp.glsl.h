...
/*
    ...
    Cmdline: sokol-shdc --input /home/johan/Downloads/sokol_scratch1/sokol-samples/sapp/primtypes-sapp.glsl --output /home/johan/Downloads/sokol_scratch1/fips-build/sokol-samples/sapp-linux-make-debug/sapp/primtypes-sapp.glsl.h --slang glsl330 --genver 5 --errfmt gcc --format sokol --bytecode

    Overview:

        Shader program 'primtypes':
            Get shader desc: primtypes_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
                    ATTR_vs_position = 0
                    ATTR_vs_color0 = 1
    ...
    Shader descriptor structs:
        ...
        sg_shader primtypes = sg_make_shader(primtypes_shader_desc(sg_query_backend()));
...
*/
static const char fs_source_glsl330[112] = {
  ...
  #error "Please include sokol_gfx.h before primtypes-sapp.glsl.h"
#endif
static inline const sg_shader_desc* primtypes_shader_desc(sg_backend backend) {
